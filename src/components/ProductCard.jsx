...
export const ProductCard=({ image, title, description,mrp, price, id })=>{
    ...
    return (
        <>
        <div className={`max-w-xs rounded-lg bg-background ${filter?'mx-3 md:mx-5 md:w-full lg:mx-4 ':''} group cursor-pointer  overflow-hidden hover:shadow-primary/40 hover:shadow-[0_0_10px] m-4 `}>
