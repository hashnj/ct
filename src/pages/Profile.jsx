...
export const Profile=()=>{
    ...
    return(
      <div className="w-screen flex lg:flex-row flex-col justify-center items-center h-screen bg-backgrounds text-text">
      ...
      <div className="lg:w-1/6 w-4/5 lg:h-3/4 m-2 flex gap-4 lg:flex-col  overflow-scroll no-scrool p-2">
      <div 
            className="shadow-[0_0_5px] hover:shadow-text/80 cursor-pointer rounded-xl shadow-text/55 p-2 py-4 font-bold text-primary text-xl flex justify-center items-center"
            onClick={()=>setAddress}
      >
              <FaPlus/> 
              <div className="flex justify-center items-center w-full ">Add Address</div>
      </div>
      </div>
      <div className="w-4/5 lg:w-3/5 h-3/4 shadow-[0_0_5px] rounded-xl shadow-text/55">
